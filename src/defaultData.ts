...
export const DEFAULT_CONTENT: ContentData = {
  hero: {
    ...
    badgeEn: 'Strategic Investment & JV Opportunity in Saudi Arabia 🇸🇦',
    headlineAr: 'كن شريكًا في الفصل القادم',
    headlineEn: 'Be a Partner in the Next Chapter',
    subheadlineAr: 'بروستد بطعم الأوسكار',
    subheadlineEn: 'Broasted with Oscar Taste',
    supportingTextAr: 'إذا الجوع فيلم… إحنا نهايته السعيدة.',
    supportingTextEn: 'If hunger is a movie… we are its happy ending.',
    ctaPrimaryAr: 'كن شريكًا',
    ctaPrimaryEn: 'Become a Partner',
    ctaSecondaryAr: 'اكتشف فرصة الاستثمار',
    ctaSecondaryEn: 'Explore Investment Opportunity',
    ctaPrimaryLink: '#investor-form',
    ctaSecondaryLink: '#opportunity',
    bgImage: '/src/assets/images/al_pacino_hero_1787630392600.jpg',
    overlayOpacity: 75,
  ...
  story: {
    ...
    quoteAr: 'SUCCESS IS NOT LUCK.',
    quoteEn: 'SUCCESS IS NOT LUCK.',
    paragraphsAr: [
      'نجاحنا لم يكن صدفة.',
  ...
  investmentGlance: {
    ...
    metrics: [
      {
        id: 'metric-1',
        valueAr: '600,000 – 700,000 ر.س',
        valueEn: 'SAR 600K – 700K',
        labelAr: 'الاستثمار التقديري للفرع',
        labelEn: 'Estimated Branch Capex',
        sublabelAr: 'شامل التجهيز والمعدات الأولية',
        sublabelEn: 'Including fit-out & equipment',
        icon: 'Coins',
      },
      {
        id: 'metric-2',
        valueAr: 'حوالي 140 م²',
        valueEn: '~ 140 sqm',
        labelAr: 'المساحة المقترحة للفرع',
        labelEn: 'Recommended Branch Footprint',
        sublabelAr: 'موقع حيوي بتصميم عصري ذكي',
        sublabelEn: 'High-density commercial site',
        icon: 'Maximize2',
      },
      {
        id: 'metric-3',
      ...
      },
      {
        id: 'metric-4',
        valueAr: 'AL PACINO',
        valueEn: 'AL PACINO Ops Team',
        labelAr: 'إدارة وتشغيل الفرع',
        labelEn: 'Management & Daily Operation',
        sublabelAr: 'تشغيل احترافي 100% بدون عناء',
        sublabelEn: '100% hassle-free turnkey execution',
        icon: 'ShieldCheck',
      },
      {
        id: 'metric-5',
        valueAr: 'JV + حق الانتفاع',
        valueEn: 'JV + Usufruct Model',
        labelAr: 'نموذج الشراكة والتشغيل',
        labelEn: 'Partnership Structure',
        sublabelAr: 'اتفاقية واضحة وموثقة لحفظ الحقوق',
        sublabelEn: 'Clear legal contractual framework',
        icon: 'FileCheck2',
      },
    ],
    disclaimerAr:
  ...
  jvModel: {
    ...
    equationPacinoEn: 'AL PACINO Operational Expertise',
  ...
  jvJourney: {
    ...
    subtitleAr: 'خطوات واضحة وسلسة للانطلاق نحو تأسيس فرع الباتشينو في مدينتك',
    subtitleEn: 'A transparent, structured roadmap to launching your AL PACINO branch',
    steps: [
      {
        stepNumber: '01',
        titleAr: 'سجل اهتمامك',
  ...
  finalCta: {
    ...
    finalStatementAr: 'استثمر. نحن نشغّل. وننمو معًا.',
    finalStatementEn: 'INVEST. WE OPERATE. GROW TOGETHER.',
    brandName: 'AL PACINO BROASTED',
    taglineAr: 'بروستد بطعم الأوسكار',
    taglineEn: 'Broasted with Oscar Taste',
    supportingTaglineAr: 'إذا الجوع فيلم… إحنا نهايته السعيدة.',
    supportingTaglineEn: 'If hunger is a movie… we are its happy ending.',
  ...
  contact: {
    ...
    phone: '+966500000000',
    email: 'invest@alpacino-broasted.sa',
...
export const INITIAL_MEDIA: MediaItem[] = [
  {
    id: 'media-1',
    url: '/src/assets/images/al_pacino_hero_1787630392600.jpg',
    title: 'طبق البروستد الملكي الفاخر - Hero',
    type: 'banner',
    category: 'hero',
    fileSize: '420 KB',
  ...
  {
    id: 'media-2',
    url: '/src/assets/images/al_pacino_story_1787630407673.jpg',
    title: 'التصميم الداخلي الفاخر للفرع - Story',
    type: 'image',
    category: 'story',
    fileSize: '380 KB',
    uploadedAt: '2026-08-24',
  ...
  {
    id: 'media-3',
    url: '/src/assets/images/al_pacino_storefront_1787630420376.jpg',
    title: 'واجهة فرع الباتشينو بروستد - Storefront',
    type: 'image',
    category: 'storefront',
    fileSize: '460 KB',
    uploadedAt: '2026-08-24',
...
export const SAMPLE_LEADS: InvestorLead[] = [
  {
    id: 'lead-1',
    fullName: 'سلطان عبدالعزيز المقرن',
    phone: '+966551234567',
    email: 'sultan.almuqrin@invest.sa',
    targetCity: 'الرياض',
  ...
  {
    id: 'lead-2',
    fullName: 'فيصل عبدالرحمن الغامدي',
    phone: '+966509876543',
    email: 'faisal.ghamdi@group.com',
    targetCity: 'جدة',
  ...
  },
  {
    ...
    phone: '+966543322110',
    email: 'khaled.aldossary@gmail.com',
    targetCity: 'الدمام والخبر',
    hasProposedLocation: true,
    budgetRange: '600,000 – 700,000 ريال',
    investmentInterest: 'فرع واحد',
    notes: 'يرغب في افتتاح فرع في كورنيش الخبر.',
